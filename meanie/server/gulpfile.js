...
gulp.task('less', function () {
    compileLess('photohubuser');
    compileLess('photohubhome');
...
gulp.task('scripts', function () {
    compileScripts('photohubuser');
    compileScripts('photohubhome');
...
gulp.task('watch', function () {
    setupWatches('photohubuser');
    setupWatches('photohubhome');
